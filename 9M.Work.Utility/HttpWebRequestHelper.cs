...
namespace _9M.Work.Utility
{
    ...
    public class HttpWebRequestHelper
    {
        ...
        private readonly static string ENCODINGNAME = "UTF-8";
        ...
        {
            return Get(uri, uri, ENCODINGNAME);
        }
        ...
        {
            return Get(uri, refererUri, ENCODINGNAME);
        }
        ...
        /// <param name="refererUri">来源url</param>
        /// <returns></returns>
        public static Stream GetStream(string uri, string refererUri)
        {
        ...
        /// <param name="webproxy">代理</param>
        /// <returns></returns>
        public static Stream GetStream(string uri, string refererUri, WebProxy webproxy)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(uri);
        ...
        {
            return Post(uri, uri, postData, ENCODINGNAME);
        }
        ...
        /// <param name="postData">提交的数据</param>
        /// <returns></returns>
        public static string Post(string uri, string refererUri, string postData)
        {
            return Post(uri, refererUri, postData, ENCODINGNAME);
        }
        ...
        /// <param name="encodingName">编码名称  例如：gb2312</param>
        /// <returns></returns>
        public static string Post(string uri, string refererUri, string postData, string encodingName)
        {
        ...
        /// <param name="webproxy">代理</param>
        /// <returns></returns>
        public static string Post(string uri, string refererUri, string postData, string encodingName, WebProxy webproxy)
        {
            string html = string.Empty;
