...
namespace SysUpdate
{
    ...
    {
        //基本设置
        static private string path = @"ftp://" + FtpServerInfo.FtpIP + ":" + FtpServerInfo.FtpPort;    //目标路径
        static private string ftpip = FtpServerInfo.FtpIP;    //ftp IP地址
        static private string username = FtpServerInfo.FtpUser;   //ftp用户名
        static private string password = FtpServerInfo.FtpPwd;   //ftp密码
