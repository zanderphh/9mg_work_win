    ...
    public class FtpClient
    {
        ...
        public void Login()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new FtpException("数据有错误", ex);
            }
        ...
        public string[] GetFileList(string mask)
        {
            ...
            while (timeout > DateTime.Now)
            {
                ...
                this.message += Encoding.Default.GetString(buffer, 0, bytes);
        ...
        public long GetModifyTime(string fileName)
        {
            ...
            if (this.resultCode == 213)
                ...
                {
                    String modifyTime = this.result.Substring(4);
                    dt = Convert.ToInt64(modifyTime.Substring(0, modifyTime.IndexOf(".")));
                }
                else
                {
                    dt = Convert.ToInt64(this.result.Substring(4));
                }
        ...
        private string readLine()
        {
            while (true)
            {
                ...
                this.message += Encoding.Default.GetString(this.buffer, 0, this.bytes);
