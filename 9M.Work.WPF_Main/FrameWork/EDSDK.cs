...
public class EDSDK
{
    ...
    public enum ImageQuality
    {
        ...
        //EdsImageQuality_Unknown =(Int64)0xffffffff,
    }
    ...
    //                      command.将接收该命令的相机的参数
    //              inCommand - Specifies the command to be sent.指定要发送的命令
    //              inParam -     Specifies additional command-specific information.指定附加的命令特定信息
    //      Out:    None
    //
    //  Returns:    Any of the sdk errors.
    -----------------------------------------------------------------------------*/
    ...
    //
    //  Description:
    //       Sets the remote camera state or mode.设置远程摄像机状态或模式
    //
    //  Parameters:
    //       In:    inCameraRef - The reference of the camera which will receive the 
    //                      command.
    ...
    //  Returns:    Any of the sdk errors.
    -----------------------------------------------------------------------------*/
    [DllImport("/dll/EDSDK.dll")] //IntPtr inUserBuffer(第1个参数)
